...
function ListItemsTable({ title, items, color = 'text.secondary' }) {
      ...
      <CardContent>
        ...
        {pdfStatus === 'done' && pdfResult && (
          <Stack spacing={2}>
            ...
            <Stack spacing={2}>
              <ListItemsTable title="Found headings" items={pdfResult.found_headings} color="success.main" />
              <ListItemsTable title="Found questions" items={pdfResult.found_questions} color="success.main" />
              <ListItemsTable title="Found answers" items={pdfResult.found_answers} color="success.main" />
              {!passed && (
                <Stack spacing={2}>
                  <ListItemsTable title="Missing headings" items={pdfResult.missing_headings} color="error.main" />
                  <ListItemsTable title="Missing questions" items={pdfResult.missing_questions} color="error.main" />
                  <ListItemsTable title="Missing answers" items={pdfResult.missing_answers} color="error.main" />
                </Stack>
              )}
            </Stack>
          </Stack>
      ...
      <CardContent>
        ...
        {wordStatus === 'done' && wordResult && (
          <Stack spacing={2}>
            ...
            <Stack spacing={2}>
              <ListItemsTable title="Found headings" items={wordResult.found_headings} color="success.main" />
              <ListItemsTable title="Found questions" items={wordResult.found_questions} color="success.main" />
              <ListItemsTable title="Found answers" items={wordResult.found_answers} color="success.main" />
              {!passed && (
                <Stack spacing={2}>
                  <ListItemsTable title="Missing headings" items={wordResult.missing_headings} color="error.main" />
                  <ListItemsTable title="Missing questions" items={wordResult.missing_questions} color="error.main" />
                  <ListItemsTable title="Missing answers" items={wordResult.missing_answers} color="error.main" />
                </Stack>
              )}
            </Stack>
          </Stack>
